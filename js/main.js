...
function mostrar_posicion( posicion ){
    ...
    let key = "849b9c5b81b4ba77961d029b7a4c1f9b";
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=${key}&units=metric&lang=es`)
        ...
        .then( data =>{
                        climaContainer.innerHTML = `<p>${data.name}</p>
...
function agregarFormulario1() {
    ...
    formulario.addEventListener('submit', function (event) {
        ...
        Toastify({
            ...
            gravity: "botton", // Ubicación del mensaje
            position: "left",
            backgroundColor: "linear-gradient(to right, #00b09b, #96c93d)" // Color de fondo del mensaje
          }).showToast();
